                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="menu-title">
                                                ...
                                                @foreach($conn as $value)
                                                    <ul>
                                                        <li><a href="/category/{{ $value->id }}" style="font-size: 1.4rem">{{$value->title}}</a></li>
                                        ...
                                        <div class="col-md-6">
                                            <div class="banner banner-overlay">
                                                <a href="category.html">
                                                    <img src="{{ asset('./Images/Category-banner/iphone-13-256gb-didongviet_1.jpg') }}" alt="Banner">

                                                    <div class="banner-content banner-content-bottom">
                                                        <div class="banner-title text-gray">New Trends<br><span><strong>spring 2022</strong></span></div><!-- End .banner-title -->
                                    ...
                                    <div class="row no-gutters">
                                        <div class="col-md-6">
                                            ...
                                            <div class="menu-title">
                                                ...
                                                @php
                                                    $conn = DB::table('categories')->where('parent_id','=', 21)->get();
                                        ...
                                        <div class="col-md-6">
                                            <div class="banner banner-overlay">
                                                <a href="category.html">
                                                    <img src="{{ asset('./Images/Category-banner/Phụ kiện/phu-kien-iphone.jpg') }}" alt="Banner">

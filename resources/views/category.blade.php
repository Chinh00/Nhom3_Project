                            ...
                            <div class="owl-carousel owl-simple owl-nav-top carousel-equal-height carousel-with-shadow" data-toggle="owl" 
                                ...
                                <div class="product">
                                    ...
                                    <div class="product-body">
                                        ...
                                        <h3 class="product-title"><a href="product">Neato Robotics</a></h3><!-- End .product-title -->
                                        <div class="product-price">
                                            $399.00
                                        </div><!-- End .product-price -->
                                        <div class="ratings-container">
                                    ...
                                    <div class="col-6 col-md-4 col-xl-3">
                                        <div class="product">
                                            ...
                                            <div class="product-body">
                                                ...
                                                <h3 class="product-title"><a href="product">Block Side Table/Trolley</a></h3><!-- End .product-title -->
                                                <div class="product-price">
                                                    $229.00
                                                </div><!-- End .product-price -->
                                                <div class="ratings-container">
                                        ...
                                        <div class="filter-items">
                                            <div class="filter-item">
                                                <div class="custom-control custom-checkbox">
                                                    ...
                                                    <label class="custom-control-label" for="brand-1">Iphone</label>
                                            ...
                                            <div class="filter-item">
                                                <div class="custom-control custom-checkbox">
                                                    ...
                                                    <label class="custom-control-label" for="brand-3">Oppo</label>
                                                </div><!-- End .custom-checkbox -->
                                            </div><!-- End .filter-item -->

...
<!-- plugins:css -->
<link rel="stylesheet" href="{{asset('template/backend/vendors/vendors/iconfonts/font-awesome/css/all.min.css')}}">
...
<!--Datatable-->
<link href="{{asset('template/backend/vendors/fontawesome-free/css/all.min.css')}}" rel="stylesheet" type="text/css">
...
<link href="{{asset('template/backend/vendors/datatables/dataTables.bootstrap4.min.css')}}" rel="stylesheet">

{{--summernote--}}
{{--<link href="{{asset('template/backend/summernote/summernote.css')}}">--}}

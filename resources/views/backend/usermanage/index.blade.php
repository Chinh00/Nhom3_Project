    ...
    <div id="content">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <h3 class="h3  text-gray-800">Quản lý Người dùng </h3><a class="btn ml-2 mb-4 btn-sm btn-outline-dark" href="{{route('user.create')}}"><i class="mt-2 icon-plus"></i> Tạo Banner
                </a>
            </div>
            <div class="col-md-12">
